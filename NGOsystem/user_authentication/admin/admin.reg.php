    ...
    <body>
        ...
        <!-- Navigation Lists-->
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <button type="button" class="btn btn-outline-primary me-2"> <a class="btnlogin" href="/NGOsystem/user_authentication/login/login.html">Login</a></button>
                    <button type="button" class="btn btn-primary"><a class="btnsignup" href="/NGOsystem/user_authentication/signup/signup.html">Sign-up</a></button>
                </div>
            </div>
        </nav>
    ...
    <div class="align-items-center py-4 bg-body-tertiary">
        <main class="col-4 form-login m-auto"> 
            <form> 
                ...
                <h1 class="h3 mb-3 fw-normal mt-3">Admin Register</h1> 
        ...
        <section id="footer">
            ...
            <div class="container pt-5 pb-5">
                <div class="row">
                    ...
                    <img src="/asset/image/Logo.png" height="40px"> 
                    <p><b>© 2026</b></p>
                </div>
                <div class="col-md-3 footer-box">

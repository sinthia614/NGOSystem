...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if($stmt->execute()){
        ...
        header("Location: /NGOsystem/admin_dashboard/admin.dashboard.php");
            exit();
    }else{
...
<?php include 'header.php' ?>
    ...
    <h1 class="h3 mb-3 fw-normal mt-3">Admin Sign Up</h1> 
    ...
    <button class="btn btn-primary w-100 py-2 mt-3" type="submit">
        ...
        <p class="text-center text-muted mt-2 mb-0">Already have an account? <a href="/NGOsystem/user_authentication/admin/admin.login.php"

...
if(isset($_GET["search"]) && !empty($_GET["search"])){
    ...
    $sql .= " WHERE 
                ...
                assigned_project LIKE '%$search_term%' OR
...
<h4>Volunteers</h4>
<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Add Volunteer</button>
</div>
...
<td><?php echo $row['assigned_project']; ?></td>
...
<form method="POST" action="/NGOsystem/admin_dashboard/config.volunteer/update_volunteer.php">

<div class="modal-header">
<h5>Edit Volunteers</h5>
...
<input name="assigned_project" value="<?php echo $row['assigned_project']; ?>" class="form-control mb-2">
...
<form method="POST" action="/NGOsystem/admin_dashboard/config.volunteer/delete_volunteer.php">
...
<form method="POST" action="/NGOsystem/admin_dashboard/config.volunteer/insert_volunteer.php">
...
<input name="assigned_project" placeholder="Assigned Project" class="form-control mb-2" required>
